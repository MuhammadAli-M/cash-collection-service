...
from tests.collection.infra.repos.fixtures import create_status, \
    create_collector
...
class CollectorsRepoTest(TestCase):
    ...
    def test_get_tasks_works(self):
        ...
        status1 = create_status(is_frozen=True, is_active=False,
                                collector=collector)
        status2 = create_status(is_frozen=True, is_active=False,
                                collector=collector)
